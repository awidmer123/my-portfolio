...
export default function SearchGrid({ photos }) {
    ...
    <div>
      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
        {filteredPhotos.map((photo) => {
          const meta = photo.context || {};
          const folder = photo.asset_folder;
            ...
            <div key={photo.asset_id} className="break-inside-avoid rounded-xl overflow-hidden shadow-md">
              ...
              <div className="p-4 bg-white">
                ...
                <div className="flex items-center justify-between">
                  {folder && (
                    <Link href={`/albums/${folder}`} className="text-xs text-gray-400 hover:text-black underline capitalize">
                      {folder.replace(/-/g, ' ')}
                    </Link>
                  )}
